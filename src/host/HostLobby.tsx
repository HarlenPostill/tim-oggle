...
export default function HostLobby({
  ...
  return (
    <main className="flex flex-1 flex-col items-center gap-8 p-6 relative">
      <button
        onClick={toggleFullscreen}
        className="absolute top-4 right-6 p-2 text-grape/60 hover:text-ink hover:bg-black/5 rounded-full transition-colors"
